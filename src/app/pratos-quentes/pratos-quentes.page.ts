...
@Component({
  selector: 'app-pratos-quentes',
  templateUrl: './pratos-quentes.page.html',
  styleUrls: ['./pratos-quentes.page.scss'],
})
export class PratosQuentesPage implements OnInit {
  ...
  goToPaes() {
    this.router.navigateByUrl('/bebidas-sem');
  }
