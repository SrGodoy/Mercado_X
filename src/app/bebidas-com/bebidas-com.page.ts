...
@Component({
  selector: 'app-bebidas-com',
  templateUrl: './bebidas-com.page.html',
  styleUrls: ['./bebidas-com.page.scss'],
})
export class BebidasComPage implements OnInit {
  ...
  goToPaes() {
    this.router.navigateByUrl('/bebidas-com');
  }
